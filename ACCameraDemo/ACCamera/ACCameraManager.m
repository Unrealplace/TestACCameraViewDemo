...
@interface ACCameraManager ()<CAAnimationDelegate, AVCaptureMetadataOutputObjectsDelegate>{
    CGRect _frame;
    CALayer *_focusLayer;
    CALayer * _faceLayer;
}
...
@implementation ACCameraManager
+ (ACCameraManager *)cameraManager {
    static ACCameraManager * _cameraManager;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _cameraManager = [[ACCameraManager alloc] init];
    });
